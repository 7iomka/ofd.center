...
$email_to = 'info@ofd.center, e.tabakova@hello-brand.ru'; // Можно несколько, через запятую
...
switch ($type) {
    ...
    case 1:
        ...
        switch ($extra) {
            ...
            case 3 :
                $text .= ' с блока Покупка нового оборудования';
                $code = 3;
                break;

            case 4 :
                $text .= ' с блока Модернизация имеющихся касс';
                $code = 4;
                break;
        }
        break;
    ...
    case 3:
        $mail_theme = 'Заявка на покупку';
        $text .= 'Заявка на покупку';
    ...
    case 4:
        $mail_theme = 'Заявка на установку';
        $text .= 'Заявка на установку';
